---
title: Edge IQ EULA
description: The Edge IQ end user license agreement
---

EDGE IQ END USER LICENCE AGREEMENT

THIS AGREEMENT is entered into by and between you ("you", "your" or "Licensee") and
Edge IQ Inc. ("Edge IQ", "us", "we" or "Licensor") and governs your use of the Software
...
13.3. For notices or communications to Edge IQ, you may send your communication
or notice to legal@edgeiq.com.

13.4. For all other notices or communications to you, Edge IQ will contact your
administrator via email, or for notices not specific to you, through the Edge IQ
Software, Documentation or Edge IQ Services.
...
15.1. You are prohibited from exporting or re-exporting Edge IQ's Documentation or
Software unless permitted by United States law and the laws of the jurisdiction
where the materials were obtained.

15.2. Specifically, and without limitation, Edge IQ's Software and Documentation may
...
15.3. By installing or using any part of Edge IQ's Software or Documentation, you
...
16.1. If you are utilizing Edge IQ's Software or Documentation on behalf of the U.S.
...
immediately cease using Edge IQ's Software or Documentation.

17. DATA AND PRIVACY

17.1. Edge IQ's Software and Documentation may collect certain information, which may
...
data protection laws. Edge IQ uses the collected information to enhance product
functionality, deliver personalized experiences, and address technical issues.

17.2 Additionally, Edge IQ may monitor your use of the Software and Documentation
...
accordance with Edge IQ's Privacy Policy, which outlines your rights and Edge IQ's
...
collection, processing, and monitoring as described. Edge IQ will implement
appropriate measures to protect your data and comply with relevant legal and
regulatory requirements.

17.4. Unless explicitly permitted in Edge IQ's documentation or agreed upon in
writing by the parties, you are prohibited from using Edge IQ's Software or
...
18.5. Edge IQ reserves the right, at its sole discretion, to modify or replace this
...
18.6. By continuing to access or use our Edge IQ Services or Software after any
...
the Edge IQ Services or Software.
